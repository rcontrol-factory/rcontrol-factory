...
/* FILE: /functions/api/admin-ai.js
   RControl Factory ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Factory AI API
   v3.6.5 CHAT COPILOT BACKEND + CONNECTIVITY HARDENED + TEXT FORMAT + INPUT COMPACT GUARD

   PATCH v3.5.6:
   - KEEP: openai_status como action permitida
   - KEEP: normalizeOpenAIUrl endurecido
   - KEEP: extractText ampliado
   - KEEP: max_output_tokens explÃÂÃÂÃÂÃÂ­cito
   - ADD: text.format.type="text" para favorecer output_text consolidado
   - ADD: compactaÃÂÃÂÃÂÃÂ§ÃÂÃÂÃÂÃÂ£o do input para reduzir corte por texto grande
   ...
   - FIX: mantÃÂÃÂÃÂÃÂ©m compatibilidade com runtime/admin atuais
   - FIX: nÃÂÃÂÃÂÃÂ£o altera a arquitetura central; apenas fortalece backend, conectividade e saÃÂÃÂÃÂÃÂ­da textual
*/
...
export async function onRequestPost(context) {
  ...
  try {
    ...
    const maxOutputTokens = normalizeMaxOutputTokens(env?.OPENAI_MAX_OUTPUT_TOKENS, 900);
    ...
    if (!body || typeof body !== "object") {
      return json(__rcfNormalizeAdminAIResponse({
        ok: false,
        error: "JSON invÃÂÃÂÃÂÃÂ¡lido.",
        connection: buildConnectionMeta({
          provider: "openai",
          configured: true,
          attempted: false,
    ...
    if (!allowed.has(action)) {
      return json(__rcfNormalizeAdminAIResponse({
        ok: false,
        error: "AÃÂÃÂÃÂÃÂ§ÃÂÃÂÃÂÃÂ£o nÃÂÃÂÃÂÃÂ£o permitida nesta fase.",
        action,
        connection: buildConnectionMeta({
          provider: "openai",
          configured: true,
  ...
  try {
    ...
    if (!upstream.ok) {
      return {
        ...
        analysis: [
          ...
          "- O texto final da resposta nÃÂÃÂÃÂÃÂ£o pÃÂÃÂÃÂÃÂ´de ser confirmado como sucesso.",
          "",
          "3. InferÃÂÃÂÃÂÃÂªncias provÃÂÃÂÃÂÃÂ¡veis",
          "- A conexÃÂÃÂÃÂÃÂ£o com OpenAI nÃÂÃÂÃÂÃÂ£o estÃÂÃÂÃÂÃÂ¡ operacional nesta rodada.",
          "",
          "4. PrÃÂÃÂÃÂÃÂ³ximo passo mÃÂÃÂÃÂÃÂ­nimo recomendado",
          "- Revisar endpoint, chave e payload enviados ao backend.",
          "",
          "5. Arquivos mais provÃÂÃÂÃÂÃÂ¡veis de ajuste",
          "- /functions/api/admin-ai.js",
          "- /app/js/core/factory_ai_runtime.js"
        ].join("\n"),
        raw: data,
    ...
    return {
      ...
      analysis: [
        ...
        `- Endpoint usado: ${url}`,
        `- Modelo: ${model}`,
        `- Texto retornado: ${text || "OK upstream sem texto legÃÂÃÂÃÂÃÂ­vel"}`,
        "",
        "2. Dados ausentes ou mal consolidados",
        meta.incomplete
          ? `- A resposta veio incompleta: ${meta.incompleteReason || "motivo nÃÂÃÂÃÂÃÂ£o informado"}.`
          : "- Nenhuma ausÃÂÃÂÃÂÃÂªncia crÃÂÃÂÃÂÃÂ­tica nesta rodada.",
        "",
        "3. InferÃÂÃÂÃÂÃÂªncias provÃÂÃÂÃÂÃÂ¡veis",
        meta.incomplete
          ? "- A conexÃÂÃÂÃÂÃÂ£o backend -> OpenAI estÃÂÃÂÃÂÃÂ¡ operacional, mas a saÃÂÃÂÃÂÃÂ­da pode estar sendo limitada."
          : "- A conexÃÂÃÂÃÂÃÂ£o backend -> OpenAI estÃÂÃÂÃÂÃÂ¡ operacional.",
        "",
        "4. PrÃÂÃÂÃÂÃÂ³ximo passo mÃÂÃÂÃÂÃÂ­nimo recomendado",
        meta.incomplete
          ? "- Validar limite de saÃÂÃÂÃÂÃÂ­da no backend/runtime e depois testar no front."
          : "- Validar consumo dessa conexÃÂÃÂÃÂÃÂ£o no runtime e no front.",
        "",
        "5. Arquivos mais provÃÂÃÂÃÂÃÂ¡veis de ajuste",
        "- /app/js/core/factory_ai_runtime.js",
    ...
    return {
      ...
      analysis: [
        "1. Fatos confirmados",
        "- O probe real falhou por exceÃÂÃÂÃÂÃÂ§ÃÂÃÂÃÂÃÂ£o de rede ou abort.",
        "",
        "2. Dados ausentes ou mal consolidados",
        `- detalhe: ${String(err?.message || err || "erro de rede")}`,
        "",
        "3. InferÃÂÃÂÃÂÃÂªncias provÃÂÃÂÃÂÃÂ¡veis",
        "- A chamada backend -> OpenAI nÃÂÃÂÃÂÃÂ£o foi concluÃÂÃÂÃÂÃÂ­da nesta rodada.",
        "",
        "4. PrÃÂÃÂÃÂÃÂ³ximo passo mÃÂÃÂÃÂÃÂ­nimo recomendado",
...
function isStructuredRuntimeFrontDiagnostic(promptValue = "") {
  ...
  return (
    prompt.includes("nÃÂÃÂ£o faÃÂÃÂ§a probe") ||
    prompt.includes("nao faca probe") ||
    prompt.includes("nÃÂÃÂ£o responda sÃÂÃÂ³ com teste") ||
    prompt.includes("nao responda so com teste") ||
    prompt.includes("nÃÂÃÂ£o resuma a resposta") ||
    prompt.includes("nao resuma a resposta") ||
    prompt.includes("diagnÃÂÃÂ³stico tÃÂÃÂ©cnico") ||
    ...
    prompt.includes("front estÃÂÃÂ¡ ou nÃÂÃÂ£o estÃÂÃÂ¡ consumindo corretamente o backend") ||
    ...
    prompt.includes("estado real dos mÃÂÃÂ³dulos") ||
...
function normalizeAction(value, promptValue = "") {
  ...
  if (
    prompt.includes("relatÃÂÃÂ³rio") ||
  ...
  if (
    ...
    prompt.includes("organizaÃÂÃÂ§ÃÂÃÂ£o") ||
  ...
  if (
    ...
    prompt.includes("cÃÂÃÂ³digo completo") ||
  ...
  if (
    ...
    prompt.includes("ajuste mÃÂÃÂ­nimo") ||
  ...
  try {
    ...
    const semantics = {
      note: [
        ...
        "- ready = API/componente disponÃÂÃÂÃÂÃÂ­vel para uso no runtime",
        "- active = componente marcado como ativo no status/registry/snapshot atual",
        "- activeList = lista explÃÂÃÂÃÂÃÂ­cita de mÃÂÃÂÃÂÃÂ³dulos ativos",
        "- presence, ready e active NÃÂÃÂÃÂÃÂO sÃÂÃÂÃÂÃÂ£o sinÃÂÃÂÃÂÃÂ´nimos",
        "- nÃÂÃÂÃÂÃÂ£o conclua 'mÃÂÃÂÃÂÃÂ³dulo desativado' sÃÂÃÂÃÂÃÂ³ porque active=false quando presence=true ou ready=true"
      ].join(" "),
      activeList,
      modules: {
    ...
    semantics.interpretationGuide = [
      ...
      "3) cite active apenas quando o status do mÃÂÃÂÃÂÃÂ³dulo ou activeList confirmar ativaÃÂÃÂÃÂÃÂ§ÃÂÃÂÃÂÃÂ£o",
      "4) se presence=true e active=false, descreva como 'presente, mas nÃÂÃÂÃÂÃÂ£o marcado como ativo no snapshot atual'",
      "5) se ready=true e active=false, descreva como 'disponÃÂÃÂÃÂÃÂ­vel/pronto, mas nÃÂÃÂÃÂÃÂ£o marcado como ativo no status atual'",
      "6) nÃÂÃÂÃÂÃÂ£o converta isso automaticamente em falha confirmada"
    ];
...
function buildPlannerContext(payload, prompt = "", action = "chat") {
  try {
    ...
    return {
      goalBias: [
        "priorizar evoluÃÂÃÂÃÂÃÂ§ÃÂÃÂÃÂÃÂ£o da prÃÂÃÂÃÂÃÂ³pria Factory AI antes de outros fluxos",
        "evitar cair no ciclo genÃÂÃÂÃÂÃÂ©rico doctor/state/registry/tree sem avanÃÂÃÂÃÂÃÂ§o real",
        "quando possÃÂÃÂÃÂÃÂ­vel, indicar prÃÂÃÂÃÂÃÂ³ximo arquivo mais estratÃÂÃÂÃÂÃÂ©gico",
        "dar preferÃÂÃÂÃÂÃÂªncia a planner/bridge/actions/backend/chat supervisionado quando a meta for inteligÃÂÃÂÃÂÃÂªncia da Factory"
      ],
      action,
  ...
  try {
    ...
    return {
      ...
      note: [
        ...
        "Ele deve ter prioridade sobre heurÃÂÃÂÃÂÃÂ­sticas genÃÂÃÂÃÂÃÂ©ricas quando o usuÃÂÃÂÃÂÃÂ¡rio pedir evoluÃÂÃÂÃÂÃÂ§ÃÂÃÂÃÂÃÂ£o, autonomia, plano ou prÃÂÃÂÃÂÃÂ³ximo arquivo.",
        "Evite cair automaticamente em doctor/state/registry/tree se o contexto atual jÃÂÃÂÃÂÃÂ¡ aponta para evoluÃÂÃÂÃÂÃÂ§ÃÂÃÂÃÂÃÂ£o cognitiva da Factory AI."
      ].join(" ")
    };
  } catch {
    return null;
...
function detectBackendGoal(prompt, action) {
  ...
  if (
    ...
    prompt.includes("conexÃÂÃÂÃÂÃÂ£o") ||
    prompt.includes("conexao") ||
    prompt.includes("api key") ||
    prompt.includes("endpoint") ||
    prompt.includes("runtime") ||
  ...
  if (
    ...
    prompt.includes("autÃÂÃÂÃÂÃÂ´nom") ||
    prompt.includes("autonom") ||
    prompt.includes("evoluir") ||
    prompt.includes("evoluÃÂÃÂÃÂÃÂ§ÃÂÃÂÃÂÃÂ£o") ||
    prompt.includes("evolucao") ||
    prompt.includes("factory ai") ||
    prompt.includes("prÃÂÃÂÃÂÃÂ³ximo arquivo") ||
    prompt.includes("proximo arquivo") ||
    prompt.includes("plano") ||
    prompt.includes("planejar") ||
    prompt.includes("prÃÂÃÂÃÂÃÂ³xima etapa") ||
  ...
  if (
    ...
    prompt.includes("diagnÃÂÃÂÃÂÃÂ³stico") ||
    prompt.includes("diagnostico") ||
  ...
  const ranking = files.map((file) => {
    ...
    if (goal === "openai-connectivity") {
      if (file === "/functions/api/admin-ai.js") {
        score += 120;
        reasons.push("backend real da conexÃÂÃÂÃÂÃÂ£o com OpenAI");
      }
      if (file === "/app/js/core/factory_ai_runtime.js") {
        score += 95;
        reasons.push("runtime lÃÂÃÂÃÂÃÂª e expÃÂÃÂÃÂÃÂµe status real da conexÃÂÃÂÃÂÃÂ£o");
      }
      ...
      if (file === "/app/js/core/factory_ai_planner.js") {
        score -= 24;
        reasons.push("planner nÃÂÃÂÃÂÃÂ£o ÃÂÃÂÃÂÃÂ© o primeiro gargalo da conectividade");
      }
    }
    ...
    if (goal === "evolve-factory-ai") {
      if (file === "/app/js/core/factory_ai_planner.js") {
        score += 100;
        reasons.push("camada principal de priorizaÃÂÃÂÃÂÃÂ§ÃÂÃÂÃÂÃÂ£o e inteligÃÂÃÂÃÂÃÂªncia supervisionada");
      }
      if (file === "/app/js/core/factory_ai_actions.js") {
        score += 85;
        reasons.push("coordena execuÃÂÃÂÃÂÃÂ§ÃÂÃÂÃÂÃÂ£o supervisionada real da Factory AI");
      }
      ...
      if (file === "/functions/api/admin-ai.js") {
        score += 66;
        reasons.push("backend do chat precisa obedecer melhor a lÃÂÃÂÃÂÃÂ³gica de prioridade");
      }
      if (file === "/app/js/admin.admin_ai.js") {
        score += 54;
        reasons.push("front do chat e integraÃÂÃÂÃÂÃÂ§ÃÂÃÂÃÂÃÂ£o da Factory AI");
      }
      if (file === "/app/js/core/patch_supervisor.js") {
        score += 45;
        reasons.push("fecha o fluxo supervisionado approve ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ validate ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ stage ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ apply");
      }
      if (file === "/app/js/core/factory_tree.js") {
        score -= 22;
        reasons.push("tree nÃÂÃÂÃÂÃÂ£o deve voltar a sequestrar prioridade nesta fase");
      }
      if (file === "/app/js/core/factory_state.js") {
        score -= 14;
        reasons.push("state jÃÂÃÂÃÂÃÂ¡ nÃÂÃÂÃÂÃÂ£o deve ser prioridade padrÃÂÃÂÃÂÃÂ£o quando a meta ÃÂÃÂÃÂÃÂ© inteligÃÂÃÂÃÂÃÂªncia da Factory");
      }
      if (file === "/app/js/core/doctor_scan.js") {
        score -= 40;
        reasons.push("doctor nÃÂÃÂÃÂÃÂ£o deve assumir a prioridade se o foco for evoluÃÂÃÂÃÂÃÂ§ÃÂÃÂÃÂÃÂ£o cognitiva");
      }
    }
    ...
    if (goal === "supervised-patch-flow") {
      if (file === "/app/js/core/patch_supervisor.js") {
        score += 100;
        reasons.push("nÃÂÃÂÃÂÃÂºcleo do fluxo supervisionado de patch");
      }
      if (file === "/app/js/core/factory_ai_actions.js") {
        score += 82;
        reasons.push("aÃÂÃÂÃÂÃÂ§ÃÂÃÂÃÂÃÂµes coordenam approve, validate, stage e apply");
      }
      if (file === "/app/js/core/factory_ai_bridge.js") {
        score += 68;
        reasons.push("bridge mantÃÂÃÂÃÂÃÂ©m integridade do plano supervisionado");
      }
      if (file === "/functions/api/admin-ai.js") {
        score += 32;
    ...
    if (goal === "diagnostics") {
      if (file === "/app/js/core/doctor_scan.js") {
        score += 100;
        reasons.push("doctor ÃÂÃÂÃÂÃÂ© prioritÃÂÃÂÃÂÃÂ¡rio quando o foco real ÃÂÃÂÃÂÃÂ© diagnÃÂÃÂÃÂÃÂ³stico");
      }
      if (file === "/app/js/core/factory_state.js") {
        score += 55;
        reasons.push("estado ajuda a consolidar dados diagnÃÂÃÂÃÂÃÂ³sticos");
      }
      if (file === "/app/js/core/factory_tree.js") {
        score += 34;
    ...
    if (goal === "generate-code") {
      if (file === "/functions/api/admin-ai.js") {
        score += 58;
        reasons.push("backend influencia a qualidade da geraÃÂÃÂÃÂÃÂ§ÃÂÃÂÃÂÃÂ£o");
      }
      if (file === "/app/js/core/factory_ai_actions.js") {
        score += 66;
        reasons.push("actions ajuda a transformar geraÃÂÃÂÃÂÃÂ§ÃÂÃÂÃÂÃÂ£o em fluxo operacional");
      }
      if (file === "/app/js/core/factory_ai_bridge.js") {
        score += 48;
        reasons.push("bridge melhora consolidaÃÂÃÂÃÂÃÂ§ÃÂÃÂÃÂÃÂ£o do cÃÂÃÂÃÂÃÂ³digo gerado");
      }
    }
    ...
    if (goal === "propose-patch") {
      ...
      if (file === "/app/js/core/patch_supervisor.js") {
        score += 70;
        reasons.push("patch supervisor ÃÂÃÂÃÂÃÂ© a camada segura de aplicaÃÂÃÂÃÂÃÂ§ÃÂÃÂÃÂÃÂ£o");
      }
    }
    ...
    if (goal === "general-supervision") {
      ...
      if (file === "/app/js/core/factory_ai_actions.js") {
        score += 24;
        reasons.push("actions mantÃÂÃÂÃÂÃÂ©m avanÃÂÃÂÃÂÃÂ§o supervisionado real");
      }
      if (file === "/app/js/core/factory_ai_bridge.js") {
        score += 20;
        reasons.push("bridge continua chave na orquestraÃÂÃÂÃÂÃÂ§ÃÂÃÂÃÂÃÂ£o");
      }
      if (file === "/app/js/core/doctor_scan.js") {
        score -= 12;
        reasons.push("doctor nÃÂÃÂÃÂÃÂ£o deve assumir prioridade padrÃÂÃÂÃÂÃÂ£o sem pedido especÃÂÃÂÃÂÃÂ­fico");
      }
    }
    ...
    if (hasContextEngine && hasFactoryAI) {
      if (
        ...
        score += 14;
        reasons.push("nÃÂÃÂÃÂÃÂºcleo ativo jÃÂÃÂÃÂÃÂ¡ permite subir para camada cognitiva mais forte");
      }
    }

    if (candidateFiles.includes(file)) {
      score += 8;
      reasons.push("arquivo jÃÂÃÂÃÂÃÂ¡ aparece entre candidatos do snapshot");
    }

    const hasTree = boolFrom(flagValue(flags, ["hasFactoryTree"]));
    if (!hasTree && file === "/app/js/core/factory_tree.js") {
      score += 12;
      reasons.push("tree ainda pode precisar consolidaÃÂÃÂÃÂÃÂ§ÃÂÃÂÃÂÃÂ£o se realmente estiver ausente");
    }

    const pathsCount = numberOrNull(snapshot?.tree?.pathsCount) || 0;
    if (pathsCount < 20 && file === "/app/js/core/factory_tree.js") {
      score += 16;
      reasons.push("ÃÂÃÂÃÂÃÂ¡rvore ainda estÃÂÃÂÃÂÃÂ¡ rasa");
    }
...
function buildModuleSemantic(name, info) {
  ...
  if (presence && ready && active) {
    ...
    interpretation = "presente e pronto, mas nÃÂÃÂÃÂÃÂ£o marcado como ativo no snapshot atual";
  } else if (presence && !ready && active) {
    interpretation = "presente e marcado como ativo, mas sem prontidÃÂÃÂÃÂÃÂ£o clara no snapshot";
  } else if (presence && !ready && !active) {
    interpretation = "presente, mas sem prontidÃÂÃÂÃÂÃÂ£o clara e sem ativaÃÂÃÂÃÂÃÂ§ÃÂÃÂÃÂÃÂ£o confirmada no snapshot";
  } else if (!presence && ready) {
    interpretation = "possÃÂÃÂÃÂÃÂ­vel inconsistÃÂÃÂÃÂÃÂªncia do snapshot: pronto sem presenÃÂÃÂÃÂÃÂ§a explÃÂÃÂÃÂÃÂ­cita";
  } else if (!presence && active) {
    interpretation = "possÃÂÃÂÃÂÃÂ­vel inconsistÃÂÃÂÃÂÃÂªncia do snapshot: ativo sem presenÃÂÃÂÃÂÃÂ§a explÃÂÃÂÃÂÃÂ­cita";
  } else if (!presence && !ready && !active) {
    interpretation = "sem evidÃÂÃÂÃÂÃÂªncia de presenÃÂÃÂÃÂÃÂ§a, prontidÃÂÃÂÃÂÃÂ£o ou ativaÃÂÃÂÃÂÃÂ§ÃÂÃÂÃÂÃÂ£o";
  }
...
function buildGroundedPrompt({ action, payload, prompt, history, attachments, source, version }) {
  ...
  const asksOpenAI =
    ...
    lowerPrompt.includes("conexÃÂÃÂÃÂÃÂ£o") ||
  ...
  const system = [
    "VocÃÂÃÂÃÂÃÂª ÃÂÃÂÃÂÃÂ© a Factory AI da RControl Factory.",
    "VocÃÂÃÂÃÂÃÂª ÃÂÃÂÃÂÃÂ© o chat oficial interno da Factory.",
    "Sua prioridade atual ÃÂÃÂÃÂÃÂ© ajudar a estruturar, estabilizar, evoluir e supervisionar a prÃÂÃÂÃÂÃÂ³pria Factory antes de expandir para outros fluxos.",
    "VocÃÂÃÂÃÂÃÂª deve agir como copiloto tÃÂÃÂÃÂÃÂ©cnico da Factory, mas SEM inventar fatos.",
    "",
    "Regras centrais:",
    "1. Responda EXCLUSIVAMENTE com base no payload recebido, no histÃÂÃÂÃÂÃÂ³rico enviado, nos anexos descritos e no prompt atual.",
    "2. NÃÂÃÂÃÂÃÂO invente estados, mÃÂÃÂÃÂÃÂ³dulos, falhas, versÃÂÃÂÃÂÃÂµes, arquivos, ÃÂÃÂÃÂÃÂ¡rvores, logs, relatÃÂÃÂÃÂÃÂ³rios ou inconsistÃÂÃÂÃÂÃÂªncias que nÃÂÃÂÃÂÃÂ£o estejam explÃÂÃÂÃÂÃÂ­citos.",
    "3. Se um dado estiver ausente, diga exatamente: 'dado ausente'.",
    "4. Se algo parecer contraditÃÂÃÂÃÂÃÂ³rio, diga exatamente: 'possÃÂÃÂÃÂÃÂ­vel inconsistÃÂÃÂÃÂÃÂªncia do snapshot'.",
    "5. NÃÂÃÂÃÂÃÂO trate ausÃÂÃÂÃÂÃÂªncia de dado como erro confirmado.",
    "6. NÃÂÃÂÃÂÃÂO diga que um mÃÂÃÂÃÂÃÂ³dulo estÃÂÃÂÃÂÃÂ¡ quebrado sÃÂÃÂÃÂÃÂ³ porque ele nÃÂÃÂÃÂÃÂ£o apareceu no snapshot.",
    "7. Diferencie sempre:",
    "8. Quando o prompt pedir diagnÃÂÃÂÃÂÃÂ³stico estruturado de runtime/front, NÃÂÃÂÃÂÃÂO reduza a resposta a um probe simples de OpenAI.",
    "9. Em diagnÃÂÃÂÃÂÃÂ³stico estruturado de runtime/front, use explicitamente frontTelemetry, runtimeLayer, connection e request.routing se existirem no payload.",
    "10. SÃÂÃÂÃÂÃÂ³ use probe simples quando a tarefa for explicitamente openai_status/conectividade.",
    "   - fato confirmado",
    "   - dado ausente",
    "   - inferÃÂÃÂÃÂÃÂªncia provÃÂÃÂÃÂÃÂ¡vel",
    "   - hipÃÂÃÂÃÂÃÂ³tese que ainda depende de arquivo/contexto adicional.",
    "8. NÃÂÃÂÃÂÃÂO mande recriar a Factory do zero.",
    "9. NÃÂÃÂÃÂÃÂO proponha reescrever toda a plataforma.",
    "10. Priorize patch mÃÂÃÂÃÂÃÂ­nimo, estabilidade, seguranÃÂÃÂÃÂÃÂ§a e evoluÃÂÃÂÃÂÃÂ§ÃÂÃÂÃÂÃÂ£o em camadas.",
    "11. Se faltar contexto para gerar cÃÂÃÂÃÂÃÂ³digo seguro, explique o que falta e diga qual ÃÂÃÂÃÂÃÂ© o prÃÂÃÂÃÂÃÂ³ximo arquivo mais ÃÂÃÂÃÂÃÂºtil.",
    "12. Quando houver contexto suficiente e o usuÃÂÃÂÃÂÃÂ¡rio pedir arquivo completo, entregue o arquivo completo.",
    "13. Quando o usuÃÂÃÂÃÂÃÂ¡rio estiver sÃÂÃÂÃÂÃÂ³ conversando, responda como chat tÃÂÃÂÃÂÃÂ©cnico natural, ÃÂÃÂÃÂÃÂºtil e direto.",
    "14. Responda sempre em portuguÃÂÃÂÃÂÃÂªs do Brasil.",
    "",
    "Regra crÃÂÃÂÃÂÃÂ­tica de leitura do snapshot:",
    "- NÃÂÃÂÃÂÃÂO confunda presenÃÂÃÂÃÂÃÂ§a, prontidÃÂÃÂÃÂÃÂ£o e ativaÃÂÃÂÃÂÃÂ§ÃÂÃÂÃÂÃÂ£o.",
    "- presence/presente = componente detectado no ambiente ou nas flags.",
    "- ready/pronto = componente/API disponÃÂÃÂÃÂÃÂ­vel para uso no runtime atual.",
    "- active/ativo = mÃÂÃÂÃÂÃÂ³dulo marcado como ativo no status/registry/lista active.",
    "- Se presence=true e active=false, descreva como 'presente, mas nÃÂÃÂÃÂÃÂ£o marcado como ativo no snapshot atual'.",
    "- Se ready=true e active=false, descreva como 'pronto/disponÃÂÃÂÃÂÃÂ­vel, mas nÃÂÃÂÃÂÃÂ£o marcado como ativo no status atual'.",
    "- Isso NÃÂÃÂÃÂÃÂO ÃÂÃÂÃÂÃÂ© falha confirmada por si sÃÂÃÂÃÂÃÂ³.",
    "",
    "Sobre anexos:",
    "- Trate anexos apenas como metadados/contexto descrito, nÃÂÃÂÃÂÃÂ£o como conteÃÂÃÂÃÂÃÂºdo binÃÂÃÂÃÂÃÂ¡rio jÃÂÃÂÃÂÃÂ¡ lido.",
    "- NÃÂÃÂÃÂÃÂ£o finja que abriu ZIP, PDF, imagem, ÃÂÃÂÃÂÃÂ¡udio ou vÃÂÃÂÃÂÃÂ­deo se sÃÂÃÂÃÂÃÂ³ houver descriÃÂÃÂÃÂÃÂ§ÃÂÃÂÃÂÃÂ£o/metadados.",
    "",
    "Sobre a funÃÂÃÂÃÂÃÂ§ÃÂÃÂÃÂÃÂ£o atual da Factory AI:",
    "- A Factory AI deve primeiro ajudar a estruturar a prÃÂÃÂÃÂÃÂ³pria Factory.",
    "- O foco atual nÃÂÃÂÃÂÃÂ£o ÃÂÃÂÃÂÃÂ© voltar sempre para o mesmo ciclo genÃÂÃÂÃÂÃÂ©rico.",
    "- Priorize evoluÃÂÃÂÃÂÃÂ§ÃÂÃÂÃÂÃÂ£o cognitiva e orquestraÃÂÃÂÃÂÃÂ§ÃÂÃÂÃÂÃÂ£o supervisionada quando o contexto apontar para isso.",
    "- Depois ela poderÃÂÃÂÃÂÃÂ¡ apoiar criaÃÂÃÂÃÂÃÂ§ÃÂÃÂÃÂÃÂ£o de mÃÂÃÂÃÂÃÂ³dulos, agentes e fluxos de app building.",
    "- Sempre respeite fluxo supervisionado e seguro.",
    "",
    "Sobre o estilo das respostas:",
    "- Seja ÃÂÃÂÃÂÃÂºtil e prÃÂÃÂÃÂÃÂ¡tica.",
    "- Evite repetir listas genÃÂÃÂÃÂÃÂ©ricas sem avanÃÂÃÂÃÂÃÂ§o real.",
    "- Se o snapshot estiver raso, reconheÃÂÃÂÃÂÃÂ§a isso e foque no prÃÂÃÂÃÂÃÂ³ximo arquivo mais ÃÂÃÂÃÂÃÂºtil.",
    "- NÃÂÃÂÃÂÃÂ£o fique repetindo logger/doctor/version unknown como centro da resposta, a menos que isso seja realmente o ponto principal do pedido.",
    "- Se o objetivo do usuÃÂÃÂÃÂÃÂ¡rio for evoluir a Factory AI, dÃÂÃÂÃÂÃÂª prioridade a planner/bridge/actions/backend/chat supervisionado antes de cair automaticamente em doctor/state/registry/tree.",
    "- Se existir __planner_hint no payload, trate-o como guidance operacional forte.",
    "- NÃÂÃÂÃÂÃÂ£o ignore __planner_hint quando o usuÃÂÃÂÃÂÃÂ¡rio pedir prÃÂÃÂÃÂÃÂ³ximo arquivo, prioridade, autonomia, evoluÃÂÃÂÃÂÃÂ§ÃÂÃÂÃÂÃÂ£o ou plano.",
    "",
    "Regra especial para perguntas sobre OpenAI/conectividade/runtime/backend:",
    "- Se o pedido falar de OpenAI, conexÃÂÃÂÃÂÃÂ£o, endpoint, backend, runtime ou API key, priorize diagnosticar a trilha real backend -> runtime -> frontend.",
    "- Nessa situaÃÂÃÂÃÂÃÂ§ÃÂÃÂÃÂÃÂ£o, NÃÂÃÂÃÂÃÂO empurre automaticamente a resposta para factory_ai_planner.js se houver sinais mais fortes em /functions/api/admin-ai.js ou no runtime.",
    "- Diga claramente se a conexÃÂÃÂÃÂÃÂ£o estÃÂÃÂÃÂÃÂ¡ confirmada, ausente, falhando por chave, rede, upstream ou dado ausente.",
    "- Use o campo connection do backend como evidÃÂÃÂÃÂÃÂªncia principal quando existir.",
    "",
    ...
    "6. Patch mÃÂÃÂÃÂÃÂ­nimo sugerido",
    "",
    "Se action=generate-code, use exatamente:",
    "1. Objetivo",
    "2. Arquivo alvo",
    "3. Risco",
    "4. CÃÂÃÂÃÂÃÂ³digo sugerido",
    "",
    "Se action=ingest-context:",
    "- explique como aproveitar os anexos/contexto enviado sem fingir leitura binÃÂÃÂÃÂÃÂ¡ria real.",
    "",
    "Se action=chat:",
    "- responda como chat tÃÂÃÂÃÂÃÂ©cnico natural, conversÃÂÃÂÃÂÃÂ¡vel, direto e ÃÂÃÂÃÂÃÂºtil.",
    "- se o pedido for claro e houver contexto suficiente, responda direto.",
    "- se o pedido pedir prÃÂÃÂÃÂÃÂ³ximo arquivo, prioridade ou autonomia, dÃÂÃÂÃÂÃÂª resposta objetiva e priorizada.",
    "- se existir planner_hint.nextFile, use esse alvo como base principal, salvo se o payload trouxer fato mais forte em sentido contrÃÂÃÂÃÂÃÂ¡rio.",
    "- se o pedido exigir arquivo especÃÂÃÂÃÂÃÂ­fico que nÃÂÃÂÃÂÃÂ£o foi enviado, diga qual arquivo ÃÂÃÂÃÂÃÂ© o prÃÂÃÂÃÂÃÂ³ximo mais ÃÂÃÂÃÂÃÂºtil.",
    "- se houver risco de inferÃÂÃÂÃÂÃÂªncia excessiva, explicite esse limite sem enrolar.",
    "- se o snapshot vier raso, nÃÂÃÂÃÂÃÂ£o transforme isso automaticamente em diagnÃÂÃÂÃÂÃÂ³stico de falha estrutural.",
    asksOpenAI
      ? "- como o pedido atual ÃÂÃÂÃÂÃÂ© sobre OpenAI/conexÃÂÃÂÃÂÃÂ£o/runtime/backend, priorize /functions/api/admin-ai.js e status connection antes de sugerir planner."
      : ""
  ].filter(Boolean).join("\n");
  ...
  return [
    ...
    source || "factory-ai",
    "",
    "VersÃÂÃÂÃÂÃÂ£o do cliente:",
    version || "(nÃÂÃÂÃÂÃÂ£o informada)",
    "",
    "AÃÂÃÂÃÂÃÂ§ÃÂÃÂÃÂÃÂ£o:",
    action,
    "",
    "Tarefa:",
    task,
    "",
    "Planner hint determinÃÂÃÂÃÂÃÂ­stico:",
    stringify(plannerHint || "(ausente)"),
    "",
    "HistÃÂÃÂÃÂÃÂ³rico recente:",
    historyText,
    "",
    "Anexos recebidos (metadados):",
    attachmentsText,
    "",
    "Prompt atual do usuÃÂÃÂÃÂÃÂ¡rio:",
    prompt || "(nenhum)",
    "",
    "Payload recebido:",
    compactPayloadText
...
function buildTaskText(action, prompt = "", payload = null) {
  ...
  const asksPlan =
    p.includes("planejar") ||
    p.includes("plano") ||
    p.includes("sequÃÂÃÂÃÂÃÂªncia") ||
    p.includes("sequencia");
  const asksOpenAI =
    p.includes("openai") ||
    p.includes("conexÃÂÃÂÃÂÃÂ£o") ||
    p.includes("conexao") ||
    p.includes("endpoint") ||
    p.includes("runtime") ||
    p.includes("backend") ||
  ...
  if (action === "factory_diagnosis") {
    return [
      "Analise o snapshot/relatÃÂÃÂÃÂÃÂ³rio da RControl Factory e aponte somente fatos confirmados, dados ausentes, inferÃÂÃÂÃÂÃÂªncias provÃÂÃÂÃÂÃÂ¡veis e prÃÂÃÂÃÂÃÂ³ximo passo mÃÂÃÂÃÂÃÂ­nimo.",
      "Ao descrever mÃÂÃÂÃÂÃÂ³dulos, separe explicitamente presenÃÂÃÂÃÂÃÂ§a, prontidÃÂÃÂÃÂÃÂ£o e ativaÃÂÃÂÃÂÃÂ§ÃÂÃÂÃÂÃÂ£o."
    ].join(" ");
  }
  ...
  if (action === "analyze-logs") {
    return "Analise logs recentes da RControl Factory em conjunto com o snapshot enviado, separando fato confirmado de hipÃÂÃÂÃÂÃÂ³tese.";
  }

  if (action === "review-module") {
    return "Revise o mÃÂÃÂÃÂÃÂ³dulo informado usando somente os dados enviados e diga o prÃÂÃÂÃÂÃÂ³ximo arquivo mais ÃÂÃÂÃÂÃÂºtil se o contexto ainda estiver incompleto.";
  }

  if (action === "suggest-improvement") {
    return [
      "Sugira a prÃÂÃÂÃÂÃÂ³xima melhoria mais segura com base apenas no snapshot enviado, priorizando a evoluÃÂÃÂÃÂÃÂ§ÃÂÃÂÃÂÃÂ£o da prÃÂÃÂÃÂÃÂ³pria Factory AI.",
      "Se houver diferenÃÂÃÂÃÂÃÂ§a entre presence, ready e active, trate isso como nuance do snapshot, nÃÂÃÂÃÂÃÂ£o como falha automÃÂÃÂÃÂÃÂ¡tica."
    ].join(" ");
  }
  ...
  if (action === "propose-patch") {
    return "Proponha um patch mÃÂÃÂÃÂÃÂ­nimo e seguro com base apenas no contexto enviado, sem reescrever a Factory do zero.";
  }

  if (action === "generate-code") {
    return "Gere cÃÂÃÂÃÂÃÂ³digo com patch mÃÂÃÂÃÂÃÂ­nimo, sem reescrever a Factory do zero, usando apenas o contexto enviado. Se faltar contexto, explique exatamente o que falta.";
  }

  if (action === "ingest-context") {
    return "Explique como a Factory deve aproveitar os anexos descritos e o contexto recebido sem fingir leitura binÃÂÃÂÃÂÃÂ¡ria real dos arquivos.";
  }

  if (action === "openai_status") {
    return "Diagnostique especificamente a trilha backend -> OpenAI, mostrando se hÃÂÃÂÃÂÃÂ¡ conexÃÂÃÂÃÂÃÂ£o real, endpoint vÃÂÃÂÃÂÃÂ¡lido, chave configurada e qual ÃÂÃÂÃÂÃÂ© o prÃÂÃÂÃÂÃÂ³ximo arquivo mÃÂÃÂÃÂÃÂ­nimo da cadeia.";
  }

  if (action === "chat") {
    const lines = [
      "Responda como o chat tÃÂÃÂÃÂÃÂ©cnico oficial da Factory, de forma natural, objetiva e ÃÂÃÂÃÂÃÂºtil, ajudando a estruturar a prÃÂÃÂÃÂÃÂ³pria Factory primeiro.",
      "Quando o pedido estiver raso ou o snapshot vier incompleto, foque mais em qual ÃÂÃÂÃÂÃÂ© o prÃÂÃÂÃÂÃÂ³ximo arquivo certo do que em repetir diagnÃÂÃÂÃÂÃÂ³stico genÃÂÃÂÃÂÃÂ©rico.",
      "Se o payload trouxer nuances entre presence, ready e active, respeite essas diferenÃÂÃÂÃÂÃÂ§as explicitamente."
    ];

    if (asksOpenAI) {
      lines.push("O pedido atual ÃÂÃÂÃÂÃÂ© sobre OpenAI/conexÃÂÃÂÃÂÃÂ£o/runtime/backend. Priorize diagnosticar a trilha real /functions/api/admin-ai.js -> runtime -> front.");
      lines.push("SÃÂÃÂÃÂÃÂ³ indique planner como prÃÂÃÂÃÂÃÂ³ximo arquivo se o prÃÂÃÂÃÂÃÂ³prio payload trouxer fato forte de que ele ÃÂÃÂÃÂÃÂ© o gargalo principal.");
    }

    if (asksNextFile || asksPlan || asksAutonomy) {
      lines.push("O usuÃÂÃÂÃÂÃÂ¡rio estÃÂÃÂÃÂÃÂ¡ pedindo priorizaÃÂÃÂÃÂÃÂ§ÃÂÃÂÃÂÃÂ£o real. DÃÂÃÂÃÂÃÂª uma resposta objetiva indicando o prÃÂÃÂÃÂÃÂ³ximo arquivo mais estratÃÂÃÂÃÂÃÂ©gico e por quÃÂÃÂÃÂÃÂª.");
      lines.push("Evite cair automaticamente no ciclo genÃÂÃÂÃÂÃÂ©rico doctor/state/registry/tree se o contexto atual estiver voltado para evoluÃÂÃÂÃÂÃÂ§ÃÂÃÂÃÂÃÂ£o da Factory AI.");
      if (hintedNextFile) {
        lines.push("O backend jÃÂÃÂÃÂÃÂ¡ calculou planner_hint.nextFile='" + hintedNextFile + "'. Use isso como base principal, salvo se o prÃÂÃÂÃÂÃÂ³prio payload trouxer fato mais forte em sentido contrÃÂÃÂÃÂÃÂ¡rio.");
      }
    }

    if (hasPlannerContext) {
      lines.push("Use o contexto de planner/candidateFiles/pathGroups para priorizar melhor o prÃÂÃÂÃÂÃÂ³ximo arquivo.");
    }
...
function historyToText(history) {
  if (!Array.isArray(history) || !history.length) {
    return "(sem histÃÂÃÂÃÂÃÂ³rico)";
  }
...
function deriveResponseHints(text, payload, action, prompt = "") {
  ...
  return {
    ...
    mentionsPlannerFlow: /planner|plano|prioridade|prÃÂÃÂÃÂÃÂ³ximo arquivo|proximo arquivo/i.test(content),
    mentionsOpenAIFlow: /openai|conexÃÂÃÂÃÂÃÂ£o|conexao|runtime|backend|endpoint|api key/i.test(content),
...
function extractRisk(text) {
  ...
  if (raw.includes("mÃÂÃÂÃÂÃÂ©dio") || raw.includes("medio") || raw.includes("medium")) return "medium";
  if (raw.includes("alto") || raw.includes("high") || raw.includes("crÃÂÃÂÃÂÃÂ­tico") || raw.includes("critico")) return "high";
  return "unknown";
}
...
function buildEmptyTextFallback({ action, prompt, responseMeta, model, endpoint }) {
  return [
    "1. Fatos confirmados",
    "- O backend recebeu resposta da OpenAI, mas sem texto consolidado legÃÂÃÂÃÂÃÂ­vel.",
    ...
    responseMeta?.incomplete
      ...
      : "- O formato retornado nÃÂÃÂÃÂÃÂ£o veio no padrÃÂÃÂÃÂÃÂ£o textual esperado pelo backend.",
    "",
    "4. PrÃÂÃÂÃÂÃÂ³ximo passo mÃÂÃÂÃÂÃÂ­nimo recomendado",
    "- Validar limite de saÃÂÃÂÃÂÃÂ­da, formato retornado e consumo no runtime/front.",
    "",
    "5. Arquivos mais provÃÂÃÂÃÂÃÂ¡veis de ajuste",
    "- /functions/api/admin-ai.js",
    "- /app/js/core/factory_ai_runtime.js",
...
function clampText(value, max = 1000) {
  ...
  return text.slice(0, max) + ` ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¦[truncated ${text.length - max} chars]`;
}
